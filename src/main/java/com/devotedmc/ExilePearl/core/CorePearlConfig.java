...
final class CorePearlConfig implements DocumentConfig, PearlConfig {
	...
	public int getSuicideTimeoutSeconds() {
		return doc.getInteger("general.suicide_time_sec", 180);
	}
	...
	public boolean canPerform(ExileRule rule) {
		...
		case THROW_PEARL:
			return doc.getBoolean("rules.throw_pearls", false);
		...
		case KILL_MOBS:
			return doc.getBoolean("rules.kill_protected_mobs", false);

		case IGNITE:
			return doc.getBoolean("rules.ignite", false);

		case USE_BUCKET:
			return doc.getBoolean("rules.use_buckets", false);

		case USE_POTIONS:
			return doc.getBoolean("rules.use_potions", false);

		case USE_BED:
			return doc.getBoolean("rules.use_beds", false);
		...
		case USE_ANVIL:
			return doc.getBoolean("rules.use_anvils", true);
		...
		case FILL_CAULDRON:
			return doc.getBoolean("rules.fill_cauldrons", true);

		case FILL_BUCKET:
			return doc.getBoolean("rules.fill_buckets", false);
	...
	public void setRule(ExileRule rule, boolean value) {
		...
		case THROW_PEARL:
			doc.append("rules.throw_pearls", value);
			break;
		...
		case KILL_MOBS:
			doc.append("rules.kill_protected_mobs", value);
			break;
		...
		case USE_BUCKET:
			doc.append("rules.use_buckets", value);
			break;
		...
		case USE_BED:
			doc.append("rules.use_beds", value);
			break;
		...
		case USE_ANVIL:
			doc.append("rules.use_anvils", value);
			break;
		...
		case FILL_CAULDRON:
			doc.append("rules.fill_cauldrons", value);
			break;

		case FILL_BUCKET:
			doc.append("rules.fill_buckets", value);
			break;
	...
	public double getDamageLogPotionDamage() {
		return doc.getDouble("damage_log.potion_damage", 6);
	}
